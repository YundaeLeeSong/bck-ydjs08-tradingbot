...
from alphavi.services.matplotlib_service import generate_all_plots
from alphavi.services.analysis_service import analyze_stock_data
...
class YahooFinanceAPI:
    ...
    def _log_debug(self, operation, request_data, response_data):
        ...
        filename = os.path.join(_DEBUG_LOG_, f"YahooFinanceAPI.{operation}_{timestamp}.txt")
    ...
    def fetch_movers(self, screener_id="day_gainers", min_mcap=None, max_mcap=None, min_price=None, min_change=None, max_change=None):
        ...
        Args:
            ...
            max_mcap (float): Optional maximum market capitalization.
    ...
    def get_winner_tickers(self, **constraints) -> List[str]:
        """Returns a list of winning tickers (gainers)."""
    ...
    def get_stocks_table(self, tickers: List[str], graph_path: Optional[str] = None) -> StockDataTable:
        """
        Fetches data, performs analysis, optionally generates graphs, 
        and returns a comprehensive StockDataTable.
        """
